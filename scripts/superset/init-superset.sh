...
# Assigner le rôle Public aux dashboards embarqués publiés
echo "📺 Attribution du rôle Public aux dashboards..."
python /app/docker/assign_public_to_dashboards.py || echo "⚠️ Échec attribution dashboards (non bloquant)"
